...
dataset <- read.csv("C:/Users/emont/OneDrive/Escritorio/Tesis/Comparacion/Experimentation DATA 2025/Datasets/Small/Iris.csv", stringsAsFactors = FALSE)

X <- dataset[, c(2,3,4,5)]
y <- dataset$Species     
target_card <- c(50, 50, 50)
