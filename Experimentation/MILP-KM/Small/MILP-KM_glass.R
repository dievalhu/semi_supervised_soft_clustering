...
dataset <- read.csv("C:/Users/emont/OneDrive/Escritorio/Tesis/Comparacion/Experimentation DATA 2025/Datasets/Small/glass.csv", stringsAsFactors = FALSE)

X <- dataset[,1:9]
y <- dataset$Type     
target_card <- c(70, 76, 17, 13, 9, 29)
