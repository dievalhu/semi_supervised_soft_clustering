...
dataset <- read.csv("C:/Users/emont/OneDrive/Escritorio/Tesis/Comparacion/Experimentation DATA 2025/Datasets/Small/heart.csv", stringsAsFactors = FALSE)

X <- dataset[, 1:13]
y <- dataset$target     
target_card <- c(499, 526)
