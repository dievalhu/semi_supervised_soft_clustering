...
dataset <- read.csv("C:/Users/emont/OneDrive/Escritorio/Tesis/Comparacion/Experimentation DATA 2025/Datasets/Large/bike.csv")

X <- dataset[, 1:10]

y <- dataset$Cluster
target_card <- c(1399, 312, 467, 356, 290, 549, 503, 185, 374)
