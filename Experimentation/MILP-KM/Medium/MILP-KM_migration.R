...
dataset <- read.csv("C:/Users/emont/OneDrive/Escritorio/Tesis/Comparacion/Experimentation DATA 2025/Datasets/Medium/Migration.csv")

X <- dataset[, -c(3,10)]

y <- dataset$GIM_2000
target_card <- c(330, 593, 392, 93, 162, 873)
