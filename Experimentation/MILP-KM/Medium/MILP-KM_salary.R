...
dataset <- read.csv("C:/Users/emont/OneDrive/Escritorio/Tesis/Comparacion/Experimentation DATA 2025/Datasets/Medium/Salary.csv")

X <- dataset[, -c(1,2,3,5,8,10,11,12,16)]
y <- dataset$CollegeTier     
target_card <- c(226, 2772)
